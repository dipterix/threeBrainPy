...
module.exports = (env, argv) => {
    ...
    return [
        ...
        // extension.
            entry: './src/lib/extension.js',
            output: {
                filename: 'extension.js',
                chunkFormat: "module",
                path: path.resolve(__dirname, 'threebrainpy', 'extensions', 'nbextension'),
                libraryTarget: 'amd',
            },
            devtool
        },
        ...
        // It must be an amd module
            entry: ['./src/amd-public-path.js', './src/lib/index.js'],
            output: {
                filename: 'index.js',
                chunkFormat: "module",
                path: path.resolve(__dirname, 'threebrainpy', 'extensions', 'nbextension'),
        ...
        {// Embeddable threebrainpy bundle
        //
